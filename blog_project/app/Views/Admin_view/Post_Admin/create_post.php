    ...
    <div class="row justify-content-center h-100">
        <div class="card w-50 my-auto">
            ...
            <div class="card-body">
                ...
                <div class="form-group mt-3">
                        <?= form_label("Nama Komentar", "id_komentar") ?>
                        <?= form_dropdown($id_komentar) ?>
                </div>

                <div class="form-group mt-3">
                    <?= form_label("Judul Postingan", "judul_postingan") ?>
                    <?= form_input($judul_postingan) ?>
                </div>
